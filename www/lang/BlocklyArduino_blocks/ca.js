...
Blockly.Msg.GROVE_INOUT_DHT_READ_C = "température °C";
Blockly.Msg.GROVE_INOUT_DHT_READ_F = "température °F";
...
Blockly.Msg.GROVE_INOUT_BT_COMM4 = "codi pin";
...
Blockly.Msg.GROVE_LCD_RGB_SCROLL_EFFECT = "Eescrit amb un ";
...
Blockly.Msg.GROVE_EMETTEUR_IR_TOOLTIP = "Emisió d'un senyañ IR";
...
Blockly.Msg.GROVE_INOUT_BT_AT_COMM4 = "code pint";
...
Blockly.Msg.ROBOTS_MISC_IR_GET_TOOLTIP = "Permet desar el codi intraroig rebut en una variable";
...
Blockly.Msg.ROBOTS_MISC_ZUMO_BUZZER_TOOLTIP = "volume = 1-15 duració = 100-4000";
...
Blockly.Msg.IR_reception_code_TOOLTIP = "Valor del codi rebur pel receptor IR";
...
Blockly.Msg.TECHNOZONE51_TEXT7 = "Entrada botó blancc (réf : BTN1-WHITE)";
...
Blockly.Msg.TECHNOZONE51_TEXT18 = "la barrera infrarojae ";
Blockly.Msg.TECHNOZONE51_TEXT19 = "Entrada berrera infraroja (réf : BARI1)";
...
Blockly.Msg.TECHNOZONE51_TEXT28 = "la distancia mesurada en ";
...
Blockly.Msg.TECHNOZONE51_TEXT53 = "sentit horari (CERT ou FALS ?)";
...
Blockly.Msg.TECHNOZONE51_TEXT92 = "esvorra la pantall LCD";
...
Blockly.Msg.TECHNOZONE51_TEXT99 = "Escriua la pantalla LCD (réf : LCD1)";
...
Blockly.Msg.TECHNOZONE51_TEXT150 = "inicialitza el groc ";
Blockly.Msg.TECHNOZONE51_TEXT151 = "graduacions 'min max sense divisió'";
Blockly.Msg.TECHNOZONE51_TEXT152 = "títol del groc 'títol;unitat'";
Blockly.Msg.TECHNOZONE51_TEXT153 = "Definició d'un calibre HMI (réf : BT1)";
Blockly.Msg.TECHNOZONE51_TEXT154 = "posiciona el calibre ";
...
Blockly.Msg.lp2i_ledRGB_WS2812B_setPixelColor_Red = "Rooig (255 max) =";
...
Blockly.Msg.multifunction_tone_INPUT2 = "d'une freqüècia (Hz)";
...
Blockly.Msg.multifunction_segment_INPUT1 = "1ra xifra";
Blockly.Msg.multifunction_segment_INPUT2 = "2na xifra";
Blockly.Msg.multifunction_segment_INPUT3 = "3ra xifra";
Blockly.Msg.multifunction_segment_INPUT4 = "4ta xifra";
...
Blockly.Msg.RFID_reception_cle_TOOLTIP = "Permet saber si s'ha enviat un informació al mòdul RFID";
Blockly.Msg.RFID_lecture_cle_TEXT = "lecture de l'informació enviada per la RFID";
...
Blockly.Msg.ROBUNO_TEXT1 = "activar l'alarma col·lisió";
...
Blockly.Msg.ROBUNO_TEXT14 = "sentit horari (CERT) o antihorari (FALS)?";
...
Blockly.Msg.ROBUNO_PIN_ANALOG = "al pin analògica";
...
Blockly.Msg.FISCHERTECHNIK_TEXT10 = "de l'escut motors CC";
...
Blockly.Msg.FISCHERTECHNIK_TEXT14 = "sentit harari (255) o antihorari (0)?";
...
Blockly.Msg.MBOT_MOTOR_RIGHT_SENS_CHANGE = "motor dret : sentir";
Blockly.Msg.MBOT_MOTOR_RIGHT_PWM = "moteur dret : potencia";
...
Blockly.Msg.ROMEO3_SWITCH_TOOLTIP = "Verifica el coomutador S1-S5 !!! Llegeix el valor de l'entrada analògica A0 : 0 per S1, 147 per S2, 333 per S3, 510 per S4, 745 per S5, 1023 per ningun";
...
Blockly.Msg.VITESSE_ROTATION_HELPURL = "En rotació";
...
Blockly.Msg.VITESSE_VENTMS_HELPURL = "En rotació";
...
Blockly.Msg.VITESSE_VENTKMH_HELPURL = "En rotació";
...
Blockly.Msg.VITESSE_VENTNOEUD_HELPURL = "En rotació";
...
Blockly.Msg.FORCE_BEAUFORT_HELPURL = "En rotació";
...
Blockly.Msg.MHK_CAPTEUR_MYOWARE2 = "al pin digital ";
...
Blockly.Msg.BT_ELEC_LED_brightness_text = "controla la lluminositat dels e LEDS";
...
Blockly.Msg.jfblocks_decode_tooltip = "dedifica una trama rebuda en format:\n<start char><nombre en ASCII><end char>\nex: D145F";
...
Blockly.Msg.jfblocks_tx_start_code = "Inici codi";
Blockly.Msg.jfblocks_tx_data = "dada";
Blockly.Msg.jfblocks_tx_end_code = "Fi codi";
...
Blockly.Msg.I2C_START_TOOLTIP = "enbia un Start + adreça de l'esclau + R/W";
...
Blockly.Msg.I2C_AVAILABLE_HW_TOOLTIP = "Retorna el nombre de dades que resten per llegir dins el buffer";
Blockly.Msg.I2C_AVAILABLE_HW_HELPURL = "";

Blockly.Msg.I2C_DATA_HW_TITRE = "I2C_DATA";
Blockly.Msg.I2C_DATA_HW_TOOLTIP = "Llegeix una dada al buffer";
...
Blockly.Msg.TSL2561_READ_TOOLTIP = "Retorna el valor de la il·luminació la valeur de la il·luminació en lux (max 17 000 lux)";
...
Blockly.Msg.AUTODUINO_INOUT_LED_TOOLTIP = "activa la sortida digital a la qual hen connetat el LED";
...
Blockly.Msg.AUTODUINO_INOUT_ROT_ANGLE_TEXT = "posició del cofificador";
...
Blockly.Msg.AUTODUINO_INOUT_TILT_TOOLTIP = "Quan el contact no es toca, el circuit està obert sinó quan el contacte toca, el circuit està tancat.";
...
Blockly.Msg.AUTODUINO_INOUT_BUZZER_TEXT1 = "posa el brunzidorr ";
...
Blockly.Msg.AUTODUINO_INOUT_TEMP_TEXT = "la temperature";
Blockly.Msg.AUTODUINO_INOUT_TEMP_TEXT2 = "la temperature";
...
Blockly.Msg.AUTODUINO_INOUT_LCD_PRINT_TOOLTIP = "escriu el text sobre una pantalla LCD sèrie de 2 línie i 16 caràcters";
...
Blockly.Msg.AUTODUINO_INOUT_PIR_TOOLTIP = "el sensor retorna 1 quan hi ha movimental camp de detecció";
...
Blockly.Msg.AUTODUINO_INOUT_ULTRASONIC_INPUT = "pel sensor de ultrason al pin";
...
Blockly.Msg.AUTODUINO_TEXT91 = "Foncions especials de la pantalla LCD (réf : LCD1)";
...
Blockly.Msg.BLYNK_usb_TEXT ='unicament per a un Arduino Uno connectat en USB';
...
Blockly.Msg.BLYNK_CONNECT_TITLE = "connecta el servidorr Blynk";
...
Blockly.Msg.ETHERNET_CONNECTED_TITLE = "Emquesta Client";
...
Blockly.Msg.ETHERNET_READ_TOOLTIP = "Llegeix el byte següènt rebut del servidor al qual s'ha connectat el client (després de la darrera cridada per llegir()).";
...
Blockly.Msg.HX711_INIT_TOOLTIP = "punt de referència per les mesures, amb o sense carrega real, llegiu el valor del calibratge en la consola a obrirr";
...
Blockly.Msg.lm35_2 = "retorna la temperatura mesurada per un LM35 en graus celcius (de 0 à 80°)";
...
Blockly.Msg.ms_ACTION_FRONT = "pata endavant";
Blockly.Msg.ms_ACTION_REAR = "pata endarrere";
