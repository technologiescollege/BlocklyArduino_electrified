...
Blockly.Msg.CAT_ARRAY = "llistes - tables";
Blockly.Msg.CAT_COLOR = "colors";
Blockly.Msg.CAT_VARIABLES = "variables";
Blockly.Msg.CAT_FUNCTIONS = "procediments & funcions";
...
Blockly.Msg.CAT_ARDUINO_TIME = " - temps & durades";
...
Blockly.Msg.CAT_ADAFRUIT_MOTORSHIELD_v1 = " - Adafruit escutmotor v1";
Blockly.Msg.CAT_ADAFRUIT_MOTORSHIELD_v2 = " - Adafruit escutmotor v2";
Blockly.Msg.CAT_ADAFRUIT_JOYSTICK = " - Joystick";

Blockly.Msg.CAT_BLYNK_CC = "BLYNK.CC"; //Added by M. Leroy July 24th 2017
Blockly.Msg.CAT_Blynk_Arduino_Connexion =" - mode de connexió";
...
Blockly.Msg.CAT_Blynk_Other = " - altres";
Blockly.Msg.CAT_Blynk_Sensors = " - sensors de telefon intel·ligent";


Blockly.Msg.CAT_DFRobot = "DFRobot";
Blockly.Msg.CAT_DFRobot_SHIELD_LCDKEYPAD = " - targeta LCD teclat númeric"; //Added february 27th 2016
Blockly.Msg.CAT_DFPLAYER = " - DFPlayer mini MP3";
Blockly.Msg.CAT_DFRobot_ISD1820 = " - micròfon ISD1820";

Blockly.Msg.CAT_LED_RGB_CHAIN = "LED RGB en sèrie";
...
Blockly.Msg.CAT_FISCHERTECHNIK_MOTORS_CC = " - motors CC";
...
Blockly.Msg.CAT_GROVE_COMM = " - communicació";
...
Blockly.Msg.CAT_TECHNOZONE_TELEC = " - comandament a distància";
...
Blockly.Msg.CAT_ROBOTS_MOTORS = "targetes motors";
...
Blockly.Msg.CAT_BQ_COMM = " - communicació";

Blockly.Msg.CAT_JEULIN = "encreuament semafòric";  //added january 11th 2016
Blockly.Msg.CAT_JEULIN_IN = " - sensors";
Blockly.Msg.CAT_JEULIN_OUT = " - actuadors";

Blockly.Msg.CAT_MULTIFUNCTION = "multifunció";  //added march 9th 2016
...
Blockly.Msg.CAT_STEPPER = "Motors pas à pas"; //added august 28th 2016
...
Blockly.Msg.CAT_LCD_DFRobot_SHIELD_LCDKEYPAD = " - DFRobot LCD teclat numèric";
...
Blockly.Msg.CAT_SHARP = "Telèmetre Sharp infraroig";

Blockly.Msg.CAT_MATRIX_LED_RGB = "Matriu 8x8 LED RGB"; //added 25 march 2017
...
Blockly.Msg.CAT_AUTODUINO_COMM = " - communicació";
...
Blockly.Msg.CAT_HX711 = "sensors de pes"; //added 23/10/2017

Blockly.Msg.CAT_MESURE = "Aparells de mesure"; //added 22/11/2017
Blockly.Msg.CAT_DS18B20 = "Termòmetre DS18B20"; //added 15/09/2017
Blockly.Msg.CAT_TSL2561 = "Luxòmetre"; //added november 21th 2017
...
Blockly.Msg.CAT_FONCTION_AFFICHAGE = "Visualització";
Blockly.Msg.CAT_FONCTION_CAPTEURS = "sensors";
Blockly.Msg.CAT_FONCTION_MOTEURS = "Ordre motors";
Blockly.Msg.CAT_FONCTION_ENTREES = "Entrades";
Blockly.Msg.CAT_FONCTION_SORTIES = "Sortides";
Blockly.Msg.CAT_FONCTION_BUS = "Bus de communication / Enllaços";
Blockly.Msg.CAT_FONCTION_WIRELESS = "Communicació sense fils";
...
Blockly.Msg.CAT_FONCTION_CAPTEURS_BATTERY = "Monitorització de la bateria";
...
Blockly.Msg.CAT_FONCTION_MOTEURS_SERVO = "Servo Motors";
...
Blockly.Msg.CAT_FONCTION_BUS_I2C_SOFT = "Programari I2C";
Blockly.Msg.CAT_FONCTION_BUS_I2C_HARD = "Maquinari I2C";
